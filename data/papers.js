...
function makePaper({ number, sourceUrl, answers }) {
  ...
  return {
    ...
    questions: answers.map((answer, index) => {
      ...
      return {
        ...
        number: index + 1,
        answer,
        image: `${BASE_PATH}/questions/${slug}/q-${q}.webp`,
...
export const papers = [
  ...
  makePaper({ number: 20, sourceUrl: "https://drive.google.com/file/d/1_5KOMuoobEkbkq2LHoPhcHO9W_A9yCnA/view", answers: [3, 1, 2, 3, 2, 3] }),
  makePaper({ number: 21, sourceUrl: "https://drive.google.com/file/d/1zrrisAycPZnkivf9L1uxMuzXoQk1Oc5b/view", answers: [4, 1, 2, 2] }),
];
